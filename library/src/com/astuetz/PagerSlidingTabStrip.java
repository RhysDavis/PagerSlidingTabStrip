...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private Typeface tabUnselectedTypeface = null;
    private int tabUnselectedTypefaceStyle = Typeface.NORMAL;
	...
	private void updateActivateTab(final int position) {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
                ...
                int style = position != i ? tabUnselectedTypefaceStyle : tabTypefaceStyle;
                Typeface typeface = position != i ? tabUnselectedTypeface : tabTypeface;
                tab.setTypeface(typeface, style);
			} else {
    ...
    public void setTypefaceUnselected(Typeface typeface, int style) {
        this.tabUnselectedTypeface = typeface;
        this.tabUnselectedTypefaceStyle = style;
        updateTabStyles();
    }
